...
pub mod updater;
use commands::{
    StartupLocalSttWarmupTarget, TtsSetupState, clear_dictation_recordings,
    clone_coqui_voice, deactivate_local_stt_model, delete_local_stt_model, download_local_stt_model,
    ensure_voice_model, fetch_local_stt_models, fetch_ollama_models, fetch_provider_models,
    get_assistant_info, get_coqui_status, get_dictation_recording, get_local_stt_download_status,
    get_local_stt_hardware_advice, get_local_stt_model_status, get_local_stt_runtime_state,
    get_tts_runtime_setup_status, get_ollama_status, install_ollama, list_coqui_models,
    list_coqui_voices, list_dictation_recording_ids, list_dictation_recordings_stats,
    load_persisted_local_settings, open_local_stt_model_path, preview_coqui_voice,
    pull_ollama_model, save_dictation_recording, save_persisted_local_settings,
    setup_assistant_runtime, setup_coqui_runtime, start_tts_runtime_setup, validate_coqui,
    validate_piper, warmup_local_stt_model,
};
use state::AppState;
use audio::vad;
