...
pub mod updater;
use commands::{
    StartupLocalSttWarmupTarget, TtsSetupState, check_for_app_update, clear_dictation_recordings,
    clone_coqui_voice, deactivate_local_stt_model, delete_local_stt_model, download_and_install_app_update,
    ...
    open_local_stt_model_path, preview_coqui_voice, pull_ollama_model, save_dictation_recording,
    save_persisted_local_settings, set_tray_update_available, setup_assistant_runtime,
    setup_coqui_runtime, show_update_settings, start_tts_runtime_setup, validate_coqui,
...
fn emit_update_install_progress(
    ...
    let payload = commands::updater::AppUpdateInstallProgressEvent {
