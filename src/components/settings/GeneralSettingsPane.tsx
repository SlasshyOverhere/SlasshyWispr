    ...
    <section className="settings-pane is-active" data-settings-pane="general">
      ...
      <details className="settings-section">
        ...
        <div className="section-body">
          ...
          <label className="switch-row" htmlFor="showAppInDockToggle"><span>Show app in dock</span><input id="showAppInDockToggle" className="switch-input" type="checkbox" /></label>
