  ...
  return (
    <div id="settingsOverlay" className="settings-overlay" hidden>
      <div
        ...
        aria-describedby="settingsSectionDescription"
      >
        <header className="settings-header">
          <h2 id="settingsDialogTitle" className="settings-header-title">Settings</h2>
          <button id="closeSettingsBtn" className="close-settings" type="button">Close</button>
        </header>
