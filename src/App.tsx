  ...
  return (
    <>
      <div className="app-frame">
        ...
        <button id="openSettingsBtn" className="secondary-link" data-label="Settings" data-hotkey="Alt+," aria-label="Settings (Alt+,)" type="button">
                <span className="secondary-glyph">
                ...
                <span>Settings</span>
                <span className="nav-keyhint">Alt+,</span>
              </button>
            </nav>
          </aside>
