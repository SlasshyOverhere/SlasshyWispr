/**
 * Settings display sync — Phase 4c split from settings-service.
 *
 * Owns: validation display, dictation-language, theme-card, runtime
 * notice/visibility, document theme. Refs arrive via SettingsFormRefs;
 * the stale-pane callback is injected per call.
 */
